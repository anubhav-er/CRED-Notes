              ...
              <div class="card  border-0 mt-2">
                ...
                <form method="POST" action="{{route('product.update', ['product' => $product])}}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="notestitle" class="form-control border border-secondary mb-3" value="{{$product->notestitle}}" disabled>
                  </div>
                  <div class="form-group">
                    <label class="mb-2">Note : </label>
                    <textarea name="notescontent" class="form-control border border-secondary mb-3" style="width: 100%; height: 250px; overflow-y: auto;" disabled>{{$product->notescontent}}</textarea>
                  </div>
                </form>
              </div>
            </div>
